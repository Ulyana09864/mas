let question_arr = ['В якому році була проголошена незалежність України?','Яку країну вважають агресором у всьому цивілізованому світі?','В якому році росія почала повномаштабну війну з Україною?','Дата вторгнення рф на територію України?','В якому році був анексований Крим?'];
let a1_arr = ["1988","росія","2005","19 лютого","2007"]
let a2_arr = ["2002","Китай","2008","24 лютого","2010"]
let a3_arr = ["2000","Німеччина","2022","7 березня","2014"]
let a4_arr = ["1991","Франція","2014","12 квітня","2018"]
let answer_arr = ["1991","росія","2022","24 лютого","Брати Вінклвосси"]
